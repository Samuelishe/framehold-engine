...
- Уточнены AGENTS reading rules, добавлен `docs/DECISIONS.md`, зафиксированы email-only login direction, cardinalities/invariants, public-but-unlisted, first-publication approval, theme settings versioning, Linux VPS assumption и repository formatting через `.editorconfig`/`.gitattributes`.
